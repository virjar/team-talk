...
class NotifyContractTest {
    ...
    private fun sampleOf(type: NotifyType): IProto = when (type) {
        ...
        NotifyType.CONVERSATION_UPDATED -> Conversation(
            chatId = "c1", chatType = 1, peerUid = "u2", peerRevision = 1, chatName = "n",
            lastSeq = 9L, readSeq = 3L,
        ...
        NotifyType.GROUP_FILE_CHANGED -> com.virjar.tk.protocol.GroupFileChangedPayload(
            chatId = "c1",
            operation = com.virjar.tk.protocol.GroupFileChangedPayload.OPERATION_UPSERT,
            entry = com.virjar.tk.protocol.model.GroupFileEntry(
                entryId = "e1", chatId = "c1", parentId = null, kind = 1,
                name = "规格.md", revision = 1, createdBy = "u1", createdAt = 1L,
                updatedBy = "u1", updatedAt = 1L,
            ),
        ...
        NotifyType.TASK_STARTED -> TaskStartedPayload("00000000-0000-4000-8000-000000000001", 1, 1)
        ...
        NotifyType.PRESENCE -> com.virjar.tk.protocol.PresencePayload(
            uid = "u1",
            status = com.virjar.tk.protocol.PresencePayload.STATUS_ONLINE,
            lastSeenAt = 0L,
