...
class ExposedConversationRepository(
    ...
    override fun updateLastMessageIfCurrent(
        uid: String,
        chatId: String,
        serverSeq: Long,
        lastMsgType: Int,
    ...
    override fun markRead(uid: String, chatId: String, readSeq: Long) {
        transaction {
            val existing = Conversations.selectAll()
                .where { (Conversations.uid eq uid) and (Conversations.chatId eq chatId) }
                .singleOrNull()
     ...
     */
    override fun updatePeerReadSeq(uid: String, chatId: String, peerReadSeq: Long) {
        transaction {
            val existing = Conversations.selectAll()
                .where { (Conversations.uid eq uid) and (Conversations.chatId eq chatId) }
    ...
    override fun setPin(uid: String, chatId: String, pinned: Boolean) {
        transaction {
            Conversations.update({
                (Conversations.uid eq uid) and (Conversations.chatId eq chatId)
            }) {
    ...
    override fun setMute(uid: String, chatId: String, muted: Boolean) {
        transaction {
            Conversations.update({
                (Conversations.uid eq uid) and (Conversations.chatId eq chatId)
            }) {
    ...
    override fun setDraft(uid: String, chatId: String, draft: String?) {
        transaction {
            Conversations.update({
                (Conversations.uid eq uid) and (Conversations.chatId eq chatId)
            }) {
    ...
    override fun deleteConversation(uid: String, chatId: String) {
        transaction {
