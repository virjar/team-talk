 ...
 *  - a [defaultParagraphStyle] that keeps wrapped heading lines clear of enlarged glyphs.
 */
public enum class HeadingStyle(
    ...
    // [TT] Keep wrapped heading lines above their enlarged glyph height even when the caller's
    // base TextStyle supplies a body-sized lineHeight.
    /** Level 1 heading (`<h1>`, `# `). */
    H1(
        1,
        "# ",
        "h1",
        SpanStyle(fontSize = 2.em, fontWeight = FontWeight.Bold),
        ParagraphStyle(lineHeight = 2.5.em),
    ),
    ...
    H2(
        ...
        ParagraphStyle(lineHeight = 1.875.em),
    ),
    ...
    H3(
        ...
        "### ",
        "h3",
        SpanStyle(fontSize = 1.17.em, fontWeight = FontWeight.Bold),
        ParagraphStyle(lineHeight = 1.4625.em),
    ),
    ...
    H4(
        ...
        "#### ",
        "h4",
        SpanStyle(fontSize = 1.12.em, fontWeight = FontWeight.Bold),
        ParagraphStyle(lineHeight = 1.4.em),
    ),
    ...
    H5(
        ...
        "##### ",
        "h5",
        SpanStyle(fontSize = 0.83.em, fontWeight = FontWeight.Bold),
        ParagraphStyle(lineHeight = 1.0375.em),
    ),
    ...
    H6(
        ...
        "###### ",
        "h6",
        SpanStyle(fontSize = 0.75.em, fontWeight = FontWeight.Bold),
        ParagraphStyle(lineHeight = 0.9375.em),
    );
