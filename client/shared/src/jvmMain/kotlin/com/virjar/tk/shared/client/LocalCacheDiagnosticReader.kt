...
private val diagnosticQueries = linkedMapOf(
    ...
    "legacyDraftMirrors" to DiagnosticQuery("conversation_draft_outbox", "state = 0"),
    "legacyDraftMirrorsAwaitingProjection" to DiagnosticQuery("conversation_draft_outbox", "state = 1"),
