...
actual class HttpGroupBotManagementRepository actual constructor(
    ...
    private val transport = DesktopGroupBotHttpTransport(serverUrl, accessToken)
...
private class DesktopGroupBotHttpTransport(serverUrl: String, private val accessToken: String?) {
