...
| 文档空间（DocumentSpace） | 企业文档的一级权限根，可向用户或组织部门授权，与群聊生命周期无关 |
| 文档节点（DocumentNode） | 空间目录树中的文件夹或文档摘要，通过 parentId 组织 |
| 文档（Document） | 空间中的稳定办公对象，包含 Markdown 当前快照和 revision，不是长消息 |
