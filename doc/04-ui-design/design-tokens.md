...
| `bubbleOutgoing` | `#E8F0FF` | `#203A63` | 自己消息气泡；品牌蓝只用于小面积交互元素 |
| `bubbleOutgoingContent` | `#1D2129` | `#EDF3FF` | 自己消息正文；与气泡对比度约 13.8:1 / 10.2:1 |
...
| 角色 | 亮色 | 说明 |
|------|------|------|
| `primary` | `#3370FF` | LarkBlue，按钮、链接、焦点和选中态；不再大面积铺满气泡 |
| `onPrimary` | `#FFFFFF` | |
...
气泡角规则：四角 8dp；非连续消息时，**靠近头像的一角收 4dp**（视觉上"接"头像，替代气泡尾巴）。普通文本气泡按内容宽度收缩，只有代码块、媒体和结构化卡片才使用可用最大宽度。
