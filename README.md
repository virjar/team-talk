...
接入；私有发行使用自己的安装包身份及厂商配置，不依赖 Google 服务。
...
[0.0.5](doc/07-operations/releases/0.0.5.md)，发行协议为 0.4，最低支持 0.0；源码暂无待发布 minor，下一批新增契约将开启 0.5。内部开发按
...
iOS 源码与 Xcode 工程已接入，尚待 Apple 设备完整验收，不属于 0.0.5 已发布制品；
